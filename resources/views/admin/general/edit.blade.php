    ...
    <div class="page-content">
        ...
        <div class="portlet light bordered">
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="{{route('practice.update',$practice->id)}}" class="form-horizontal" method="post">
                    @csrf
                    @method('put')
                    <div class="form-body">
                    <h4>Real Practice result slider section</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                               <input type="text" class="form-control" name="percentage" value="{{ $practice->percentage }}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Description *</label>
                            <div class="col-md-4">
                               <textarea class="form-control"  name="description">{{$practice->description}}</textarea>
                            </div>
                        </div>
