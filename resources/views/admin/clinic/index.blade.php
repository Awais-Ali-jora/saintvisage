                ...
                <table class="table table-bordered table-striped table-condensed flip-content">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="numeric">{{$clinic->title}}</td>
                            <td class="numeric"> {{$clinic->description}}</td>
                            <td class="numeric"><img src="{{Storage::disk('public')->url($clinic->image)}}" height="100"></td>
                            <td>
                                <a href="{{route('clinic.edit',$clinic->id)}}"><i class="fa fa-edit"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
