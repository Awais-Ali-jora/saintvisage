...
<html lang="en">
    ...
    <body class=" login">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <h2 style="color:white">Saintvisage</h2>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="{{route('adminlogin')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix {{ $errors->has('email') ? ' is-invalid' : '' }}" type="text" autocomplete="off" placeholder="Username" name="email" />
                    @if ($errors->has('email'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix {{ $errors->has('password') ? ' is-invalid' : '' }}" type="password" autocomplete="off" placeholder="Password" name="password" />
        ...
        <div class="copyright"> 2021 © Saintsavage. Admin. </div>
        <!--[if lt IE 9]>
        ...
        <script src="{{ asset("admin_assets/pages/scripts/login.min.js") }}" type="text/javascript"></script>
